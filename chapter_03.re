...
//footnote[pep8_spece_2][@<code>{1 + 1}とだけ書く場合、PEP 8で示されているスペースの数は「前後に1つずつ」なので、@<code>{1+1}や@<code>{1  +  1}と書かれたコードを読むとPythonに慣れた人は違和感を覚えます。]
...
//listnum[copy_integer][@<code>{x}に@<code>{1}を、@<code>{y}に@<code>{x}を代入する]{
x = 1
y = x
//}
