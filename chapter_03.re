...
泉「お次は引き算。……と言ってもさっきとやることは変わらない。今度はこのコードを入力してみよう。マイナスの記号『@<code>{-}』は、Shiftキーを@<b>{押さずに}『ほ』って書かれてあるキーを押すと入力できるよ」
...
泉「足し算、引き算、掛け算と来たら最後はもちろん割り算だよね。割り算の記号『@<code>{÷}』も『@<code>{×}』同様全角文字だから、代わりにスラッシュ『@<code>{/}』で割り算を行うよ。Shiftキーを@<b>{押さずに}『め』を押すと入力できる記号だね」
