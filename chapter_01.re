...
泉「まずは何と言ってもPythonではコードをシンプルかつ簡単に書けること。例えば以下にC言語@<fn>{c_lang}、@<ruby>{Java, ジャバ}@<fn>{java}という2つの言語とPythonでそれぞれ"Hello, world!"という文字を出力するコードを示してみたんだけど、比べてみてどう？(@<list>{c_hello}, @<list>{java_hello}, @<list>{python_hello})」
