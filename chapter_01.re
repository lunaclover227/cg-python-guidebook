...
泉「@<kw>{Python}は1991年に開発された言語で、2025年2月現在、世界で最も利用されている言語の一つだよ(@<img>{python_org})。数値計算や画像処理、今流行りの人工知能(AI)を用いたプログラミングのほか、私たちに身近なものだとYoutubeやInstagram、Spotifyなどの開発にも利用されてたりするんだ」
