...
泉「うん。そうすると、『Colabへようこそ』と書かれた画面に遷移するんだけど(@<img>{colab_02})、これはColabのチュートリアルだね。そこに一通り目を通してもいいんだけど、初めてだと何が書いてあるかわからないと思うから、ここでは先に進めるね。次に、左上の『ファイル』から、『ドライブの新しいノートブック』をクリックしてもらえるかな？(@<img>{colab_03})Colabで実際に編集するファイルのことを@<kw>{ノートブック}というんだけど、今からそれを作っていくよ」
