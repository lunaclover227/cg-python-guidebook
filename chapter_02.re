...
りあむ「泉ちゃん。ぼくの画面、こんなのが出てきちゃったんだけど、どうすればいいの？」

//image[colab_open_notebook][「ノートブックを開く」画面]{
//}
...
泉「そうだね。名前は自由だけど、わかりやすい名前がいいかな。じゃあ、Hello, worldにならってhello_colabなんて名前はどうかな？文字を区切るときはスペースじゃなくてアンダースコア@<fn>{under_score}『_』かハイフン『-』を使うのが一般的だから、ついでに覚えちゃおう。アンダースコアはShiftキーを押しながら『ろ』と書かれたキーを、ハイフンはShiftキーを押さずに『ほ』と書かれたキーを押すと入力できるよ」
